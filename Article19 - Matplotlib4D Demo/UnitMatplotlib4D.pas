...
uses
  ...
  PythonEngine, Vcl.PythonGUIInputOutput, Vcl.ExtDlgs;
...
begin
  Image1.Picture.LoadFromFile(ExtractFilePath(ParamStr(0)) + 'matplotlibPlot.jpg');
end;
...
begin
  ...
  Memo1.Lines.LoadFromFile(ExtractFilePath(ParamStr(0)) + 'matplotlibApp.py');
end;
